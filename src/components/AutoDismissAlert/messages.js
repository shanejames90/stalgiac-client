export default {
  ...
  indexScreenshotsSuccess: 'Now displaying all of your screenshots!',
  showScreenshotSuccess: 'Your screenshot is now displayed.',
  showScreenshotFailure: 'Your screenshot is now displayed.',
